...
class iRprop_minus(Optimizer):
    ...
    def __init__(self, params, lr=1e-2, etas=(0.5, 1.2), step_sizes=(1e-6, 50)):
        ...
        super(iRprop_minus, self).__init__(params, defaults)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                """ This is actually the original Rprop from pytorch"""

                #  no back-tracking
                #p.data[sign.eq(etaminus)] -= state['prev'][sign.eq(etaminus)]
